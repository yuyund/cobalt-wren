...
See `CONFIG_SCHEMA.md` for the raw/validated/resolved boundary and validation layering.
...
Plugin-specific validation stays with plugin types and is described in `../../plugins/PLUGINS.md`.
