...
This folder captures concrete integration contracts that sit below the public facades and above implementation details.
...
- Read the checkpoint store contract when changing versioned checkpoint semantics.
