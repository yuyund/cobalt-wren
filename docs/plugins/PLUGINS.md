...
Manual registration, conflict policy, enabled plugin handling, and registry boundaries are defined in `PLUGIN_REGISTRATION.md`.
Plugin object shape, contribution shape, validation hooks, and factory hooks are defined in `PLUGIN_API_SHAPE.md`.
