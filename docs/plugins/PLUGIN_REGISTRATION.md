...
Manual registration registers plugin objects and their contributions. Plugin object and contribution shapes are defined in `PLUGIN_API_SHAPE.md`.
Public facade staging for plugin API types is defined in `PLUGIN_API_FACADE.md`.
...
Workflow contributions are part of the manual registry model, and workflow vocabulary is defined in `PLUGIN_API_SHAPE.md` and `PLUGIN_API_FACADE.md`.
