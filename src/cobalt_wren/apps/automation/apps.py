...
class AutomationConfig(AppConfig):
    ...
    name = "cobalt_wren.apps.automation"
    label = "automation"
    ...
    def ready(self) -> None:
        ...
        raw_deployment_config = load_deployment_package_config_from_settings()
        deployment_package_config = load_normalized_package_config_from_mapping(
        ...
        self.run_execution_services = build_run_execution_services(raw_deployment_config)
