...
from cobalt_wren.core.summary import preview_text, summarize_messages
...
from cobalt_wren.integrations.observability.events import SPAN_LLM
...
class ObservedLLMClient:
    ...
    def complete(self, messages: LLMRequest, **kwargs: Any) -> LLMResult:
        ...
        start_metadata = {
            ...
            'message_previews': input_summary['messages'],
        }
