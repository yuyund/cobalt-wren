...
from langgraph_automation.apps.automation.models import ExecutionJob, ExecutionJobOperation, Run
from langgraph_automation.apps.automation.services.jobs import enqueue_execution_job
from langgraph_automation.apps.automation.services.runs import RunActionResult, cancel_run, resume_run, retry_run, start_run
...
def worker_mode_enabled() -> bool:
    return str(getattr(settings, "LANGGRAPH_AUTOMATION_EXECUTION_MODE", "inline")).strip().lower() == "worker"
