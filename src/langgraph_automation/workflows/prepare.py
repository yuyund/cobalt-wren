...
from langgraph_automation.api.workflow import WorkflowContribution, WorkflowDefinition
...
class WorkflowPreparer:
    ...
    def prepare(self, *, workflow_kind: str, dependencies: RuntimeDependencies) -> PreparedWorkflow:
        try:
...
def prepare_workflow(*, workflow_kind: str, registry: PluginRegistry, dependencies: RuntimeDependencies) -> PreparedWorkflow:
    return WorkflowPreparer(registry).prepare(workflow_kind=workflow_kind, dependencies=dependencies)
