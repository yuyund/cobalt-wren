...
from cobalt_wren.apps.automation.services.runtime import load_deployment_package_config_from_settings
...
def test_runtime_loads_explicit_json_config_file(tmp_path: Path) -> None:
    ...
    with override_settings(COBALT_WREN_CONFIG_FILE=str(path), COBALT_WREN='{"version": 1, "environment": "env"}'):
